/*
 -------------------------------------------------------------------------
  ...
  History         : 07/08/02       Initial Coded
 -------------------------------------------------------------------------
*/
...
#define FMS_HST             ((unsigned int) 0x00000040)    /* Host Server    */
#define FMS_VMC             ((unsigned int) 0x00000080)    /* VM Client      */
#define FMS_BPT             ((unsigned int) 0x00000100)    /* Bypass Control */
#define FMS_PQM             ((unsigned int) 0x00000200)    /* PSQL DB Libary */
